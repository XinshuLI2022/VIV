...
class _BaseAGMM:
    ...
    def _pretrain(self, Z, T, Y,
                  ...
                  warm_start, logger, results_dir, device, verbose, add_sample_inds=False):
...
class _BaseSupLossAGMM(_BaseAGMM):
    ...
    def fit(self, Z, T, Y,  T_test_tens, 
            ...
            ols_weight=0., warm_start=False, logger=None, results_dir='.', device=None, verbose=0):
        """
        Parameters
        ----------
        Z : instruments
        ...
        Z, T, Y = self._pretrain(Z, T, Y,
                                 learner_l2, adversary_l2, adversary_norm_reg,
                                 learner_lr, adversary_lr, n_epochs, bs, train_learner_every, train_adversary_every,
                                 warm_start, logger, results_dir, device, verbose)
        ...
        for epoch in range(n_epochs):
            ...
            # if logger is not None:
            #     logger(self.learner, self.adversary, epoch, self.writer, Z, T, Y, Z_val, T_val, Y_val, T_test_tens, G_val)
